    ...
    shader("../shaders/sky_vs.glsl", "../shaders/sky_fs.glsl")
{
    ...
    coverageTex = new Texture("cloud_combined_4096.png", "../textures/", "noise");
    ...
    model_mat = glm::scale(model_mat, vec3(20000));
}
...
void Clouds::sendUniforms(Light light) {
    ...
    cloud_mat = inverse(mat4(1.0, 0.0, 0.0, 0.0,  // 1. column
    ...
    glBindTexture(GL_TEXTURE_2D, renderContext->fbo->depth_attachment->id);
